...
const MobileMenu = ({isOpen, toggle, userIsLoggedIn})=>{
            ...
            return(
                <li className="mobile-menu__categories__list__item" key={`c-${category}`}>
                    <div className="mobile-menu__categories__list__item__inner">
                        <Link onClick={()=>toggle()} to={`/c/${category}`}>
                            {capitalize(category)}    
                        </Link> 
                    </div>
                </li>
            ...
            return (
                ...
                <li className="mobile-menu__account__links__item">
                    <div className="mobile-menu__account__links__item__inner">
                        ...
                        <Link onClick={()=>toggle()} to="/accounts/myaccount">
                            My Account
                        </Link>
                    </div>
                </li>
                ...
                <>
                    <li className="mobile-menu__account__links__item">
                        <div className="mobile-menu__account__links__item__inner">
                            ...
                            <Link onClick={()=>toggle()} to="/accounts/signin">
                                Sign In
                            </Link>
                        </div>
                    </li>
                    <li className="mobile-menu__account__links__item">
                        <div className="mobile-menu__account__links__item__inner">
                            ...
                            <Link onClick={()=>toggle()} to="/accounts/signup">
                                Register
                            </Link>
                        </div>                                  
                    </li>
